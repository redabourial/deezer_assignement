...
import { validateStatus, createUser, getUser } from "./users";
...
describe("YourFile", () => {
    ...
    describe("createUser function", () => {
        it("should make a post request to create user", async () => {
            ...
            expect(axios.post).toHaveBeenCalledWith("/api/users/", {"email": "r@example.com", "name": "some name"}, {validateStatus});
    ...
    describe("getUser function", () => {
        it("should make a get request to fetch user", async () => {
            const userId = 1;
            const responseData = { id: userId, name: "some name", email: "r@example.com" };
